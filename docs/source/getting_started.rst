...
1. Check the `GitHub Issues <https://github.com/GrowKitty/GrowKitty/issues>`_ for existing solutions
2. Review the `Contributing Guidelines <https://github.com/GrowKitty/GrowKitty/blob/main/CONTRIBUTING.md>`_
3. Join community discussions in the repository
4. Contact the team through the contact page
...
2. **Read the Contributing Guidelines** to learn how to submit changes
...
For detailed contribution guidelines, see `CONTRIBUTING.md <https://github.com/GrowKitty/GrowKitty/blob/main/CONTRIBUTING.md>`_.
...
* **Issues**: https://github.com/GrowKitty/GrowKitty/issues
* **Discussions**: https://github.com/GrowKitty/GrowKitty/discussions

License
-------

GrowKitty is released under the `MIT License <https://github.com/GrowKitty/GrowKitty/blob/main/LICENSE>`_. You're free to use, modify, and distribute this software for any purpose, commercial or non-commercial.
